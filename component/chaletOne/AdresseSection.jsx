    ...
    <SectionPerso id="adresses" className="section">
      ...
      <div className="container">
        ...
        />
          ...
          <h3 className="h3 adresseTitle">🍕 Snacks</h3>
          ...
          <div className="grid">
            ...
            <div className="col col-2">
              <PlaceCard
                ...
                description={`${!isSummer ? '' : "Ambiance détendue au bord du lac, idéal pour déjeuner en terrasse avec des plats variés tirant parti des produits locaux."}`}
            ...
            <div className="col col-2">
              <PlaceCard
                ...
                description={`${!isSummer ? '' : "Snack au caming, avec vue panoramique sur le lac de la raviège"}`}
