        ...
        >           
          ...
          />
            ...
            <div className="contentImgADecouvrir">
              <Image className="imgNatureTarn hero__img" width={1920} height={1080} src={"/images/chalet1/natureTarn.png"} alt=''/>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div className="grid">
                  ...
                  <div className="col col-3">
                    ...
                    >
                    <Image className="hero__img " width={1920} height={1080} src={"/images/chalet1/raviege.png"} alt=''/>  
                  ...
                  <div className="col col-3">
                    ...
                    >
                        <Image className="hero__img" width={1920} height={1080} src={"/images/chalet1/saintPeyres.png"} alt=''/> 
                  ...
                  <div className="col col-3">
                    ...
                    >
                        <Image className="hero__img " width={1920} height={1080} src={"/images/chalet1/laousas.png"} alt=''/>
                  ...
                  <Card emoji="🌳" title="Sur les traces de l'Enfant Sauvage – Une aventure en famille à Lacaune" distance="≈ 35min">
                      <div className="cardContent">
                          <div className="list">
                                ...
                                <div className="list-item"><li>Spécialement conçue pour les familles avec enfants à partir de 4 ans. Inspiré de l'histoire vraie de Victor, l'Enfant Sauvage découvert dans les bois de Lacaune en 1798</li></div>
                                <div className="list-item"><li>📍 À environ 8 km de Lacaune, dans les bois de la Bassine.</li></div>
                                <div className="list-item"><li>🚶 Parcours en boucle de 3,5 km (environ 2 h à 2 h 30).</li></div>
                                <div className="list-item"><li>👨‍👩‍👧 Adapté aux familles et aux enfants dès 4 ans.</li></div>
                                <div className="list-item"><li>🥾 Prévoir de bonnes chaussures de marche.</li></div>
                                <div className="list-item"><li>🚫 Sentier non accessible aux poussettes.</li></div>
                                <div className="list-item"><li>🧺 Aire de pique-nique ombragée à proximité, idéale pour une pause en famille.</li></div>
                          </div>
                      </div>
                  </Card>
              </div>
